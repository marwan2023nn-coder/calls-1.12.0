...
export const CallErrorModal = (props: Props) => {
    ...
    const onConfirm = () => {
        if (props.err.message === insecureContextErr.message) {
            window.open('https://workspace.com/pl/calls-deployment?utm_source=mattermost&utm_medium=in-product&utm_content=calls_error_modal', '_blank');
        }
        return null;
    };
    ...
    const onTroubleShootingClick = (ev: React.MouseEvent) => {
        ev.preventDefault();
        window.open('https://workspace.com/pl/calls-make-troubleshooting?utm_source=mattermost&utm_medium=in-product&utm_content=calls_error_modal', '_blank');
    };
            ...
            {formatMessage(
                ...
                },
                {
                    troubleShootingLink: (text: React.ReactNode) => (
                        <a
                            href='https://workspace.com/pl/calls-make-troubleshooting?utm_source=mattermost&utm_medium=in-product&utm_content=calls_error_modal'
